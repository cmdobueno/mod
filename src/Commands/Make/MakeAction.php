...
class MakeAction extends Command
{
     ...
     * @var string
     */
    protected $signature = 'mod:action {name} {--module=}';
     ...
     * @var string
     */
    protected $description = 'This will create a action in a specific package.';
    /**
     * @var Filesystem
     */
    private $pathway = 'Actions';
    private $files;
    protected $name;
    private $vendor;
...
//        $this->name = $this->argument('name');
        ...
        //Get our stub
        $stub = $this->files->get(base_path($this->vendor . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'stubs' . DIRECTORY_SEPARATOR . 'action.stub'));
        
        //Get variables for replacement
        $namespace = 'App\\Modules\\' . $this->module . '\\Actions' . $this->extra_namespace;
        ...
        $this->info('Action has been generated successfully.');
        return 0;
    }
}
