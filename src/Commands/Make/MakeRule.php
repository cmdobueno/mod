...
class MakeRule extends Command
{
     ...
     * @var string
     */
    protected $signature = 'mod:rule {name} {--module=}';
     ...
     * @var string
     */
    protected $description = 'This will create a rule in a specific package.';
    /**
     * @var Filesystem
     */
    private $pathway = 'Rules';
    private $files;
    protected $name;
    private $vendor;
...
//        $this->name = $this->argument('name');
        ...
        //Get our stub
        $stub = $this->files->get(base_path($this->vendor . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'stubs' . DIRECTORY_SEPARATOR . 'rule.stub'));
        
        //Get variables for replacement
        $namespace = 'App\\Modules\\' . $this->module . '\\Rules' . $this->extra_namespace;
        ...
        $this->info('Rule has been generated successfully.');
        return 0;
    }
}
