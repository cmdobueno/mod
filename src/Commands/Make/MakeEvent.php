...
class MakeEvent extends Command
{
     ...
     * @var string
     */
    protected $signature = 'mod:event {name} {--module=}';
     ...
     * @var string
     */
    protected $description = 'This will create a event in a specific package.';
    /**
     * @var Filesystem
     */
    private $pathway = 'Events';
    private $files;
    protected $name;
    private $vendor;
...
//        $this->name = $this->argument('name');
        ...
        //Get our stub
        $stub = $this->files->get(base_path($this->vendor . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'stubs' . DIRECTORY_SEPARATOR . 'event.stub'));
        
        //Get variables for replacement
        $namespace = 'App\\Modules\\' . $this->module . '\\Events' . $this->extra_namespace;
        ...
        $this->info('Event has been generated successfully.');
        return 0;
    }
}
