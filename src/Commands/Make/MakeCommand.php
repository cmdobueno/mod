...
class MakeCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'mod:command {name} {--module=}';
     ...
     * @var string
     */
    protected $description = 'This will create a command in a specific package.';
    /**
     * @var Filesystem
     */
    private $pathway = 'Console' . DIRECTORY_SEPARATOR . 'Commands';
    private $files;
    protected $name;
    private $vendor;
...
//        $this->name = $this->argument('name');
        ...
        //Get our stub
        $stub = $this->files->get(base_path($this->vendor . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'stubs' . DIRECTORY_SEPARATOR . 'command.stub'));
        
        //Get variables for replacement
        $namespace = 'App\\Modules\\' . $this->module . '\\Console\\Commands' . $this->extra_namespace;
