...
class MakeRequest extends Command
{
     ...
     * @var string
     */
    protected $signature = 'mod:request {name} {--module=}';
     ...
     * @var string
     */
    protected $description = 'This will create a request in a specific package.';
    /**
     * @var Filesystem
     */
    private $pathway = 'Requests';
    private $files;
    protected $name;
    private $vendor;
...
//        $this->name = $this->argument('name');
        ...
        //Get our stub
        $stub = $this->files->get(base_path($this->vendor . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'stubs' . DIRECTORY_SEPARATOR . 'request.stub'));
        
        //Get variables for replacement
        $namespace = 'App\\Modules\\' . $this->module . '\\Requests' . $this->extra_namespace;
        ...
        $this->info('Request has been generated successfully.');
        return 0;
    }
}
