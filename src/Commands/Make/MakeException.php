...
class MakeException extends Command
{
     ...
     * @var string
     */
    protected $signature = 'mod:exception {name} {--module=}';
     ...
     * @var string
     */
    protected $description = 'This will create a exception in a specific package.';
    /**
     * @var Filesystem
     */
    private $pathway = 'Exceptions';
    private $files;
    protected $name;
    private $vendor;
...
//        $this->name = $this->argument('name');
        ...
        //Get our stub
        $stub = $this->files->get(base_path($this->vendor . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'stubs' . DIRECTORY_SEPARATOR . 'exception.stub'));
        
        //Get variables for replacement
        $namespace = 'App\\Modules\\' . $this->module . '\\Exceptions' . $this->extra_namespace;
        ...
        $this->info('Exception has been generated successfully.');
        return 0;
    }
}
