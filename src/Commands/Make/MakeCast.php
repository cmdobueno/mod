...
class MakeCast extends Command
{
     ...
     * @var string
     */
    protected $signature = 'mod:cast {name} {--module=}';
     ...
     * @var string
     */
    protected $description = 'This will create a cast in a specific package.';
    /**
     * @var Filesystem
     */
    private $pathway = 'Casts';
    private $files;
    protected $name;
    private $vendor;
...
//        $this->name = $this->argument('name');
        ...
        //Get our stub
        $stub = $this->files->get(base_path($this->vendor . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'stubs' . DIRECTORY_SEPARATOR . 'cast.stub'));
        
        //Get variables for replacement
        $namespace = 'App\\Modules\\' . $this->module . '\\Casts' . $this->extra_namespace;
