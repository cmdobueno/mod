...
class MakeProvider extends Command
{
     ...
     * @var string
     */
    protected $signature = 'mod:provider {name} {--module=}';
     ...
     * @var string
     */
    protected $description = 'This will create a provider in a specific package.';
    /**
     * @var Filesystem
     */
...
//        $this->name = $this->argument('name');
        ...
        //Get our stub
        $stub = $this->files->get(base_path($this->vendor . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'stubs' . DIRECTORY_SEPARATOR . 'provider.stub'));
        
        //Get variables for replacement
        $namespace = 'App\\Modules\\' . $this->module . '\\Providers' . $this->extra_namespace;
        ...
        $this->info('Provider has been generated successfully.');
        return 0;
    }
}
